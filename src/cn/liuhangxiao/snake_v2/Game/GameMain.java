...
public class GameMain extends JFrame implements GameListener {
    ...
    //游戏图标
    private Image mini_logo = ImageIO.read(GameMain.class.getResource("/img/logo.png"));
    ...
    public GameMain(Controller c) throws IOException {
        ...
        this.setJMenuBar(menuBar);//给窗体添加菜单栏

        /* 开始菜单栏 */
        JMenu menu_start = new JMenu("开始");
        menu_start.setFont(new Font("宋体", Font.PLAIN, 14));//设置字体
        menuBar.add(menu_start);//将开始添加到菜单栏

        /*添加“开始”菜单的菜单项*/
        //新游戏
        JMenuItem start_menu_button = new JMenuItem("新游戏(R)");
        start_menu_button.setFont(new Font("宋体", Font.PLAIN, 14));
        start_menu_button.addActionListener(new ActionListener() {
            @Override
        ...
        skip_menu_button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        stop_menu_button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                controller.stopGame();
            }
        ...
        background_menu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        snake_head_menu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        snake_body_menu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        food_menu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        grid_color_menu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        menu_option.add(grid_color_menu);//调整网格线按钮顺序

        menu_option.addSeparator();
        //恢复默认设置
        JMenuItem reset_menu = new JMenuItem("恢复默认");
        reset_menu.setFont(new Font("宋体", Font.PLAIN, 14));
        reset_menu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        /* ============按钮面板 ==================== */
        JPanel subPanel = new JPanel();//初始化按钮面板
        subPanel.setLayout(null);
        subPanel.setBorder(new EtchedBorder(EtchedBorder.LOWERED));//设置边框
        subPanel.setFocusable(false);//设置聚焦状态
        ...
        /* ==========说明=============== */
        JPanel infoPanel = new JPanel();//初始化组件
        infoPanel.setBorder(new EtchedBorder(EtchedBorder.LOWERED));//定义边框
        ...
        /* 信息标题框 */
        final JLabel infoTitleLabel = new JLabel();//初始化组件
        //设置字体
        ...
        infoTextArea.setFocusable(false);//聚焦状态
        ...
        /* 添加名片背景 */
        ImageIcon name_loge = new ImageIcon(GameMain.class.getResource("/img/name_logo.png"));
        ...
        this.getContentPane().add(subPanel);//添加游戏面板
        this.getContentPane().add(optionPanel);//添加控制面板
        this.getContentPane().add(infoPanel);//添加信息面板
    }
